...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-background flex flex-col">
      <header className="px-4 sm:px-6 py-8 sm:py-12 max-w-2xl mx-auto w-full">
        <div className="font-mono text-xs text-muted-foreground mb-4">
          <span className="text-primary">~</span>/annual-review
        </div>
        <h1 className="text-lg sm:text-xl font-mono font-medium tracking-tight text-foreground">
      ...
      <section className="px-4 sm:px-6 pb-16 sm:pb-20 max-w-2xl mx-auto w-full flex-1">
      ...
      <footer className="px-4 sm:px-6 py-6 sm:py-8 max-w-2xl mx-auto w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
        <div className="flex items-center gap-4">
          <p className="text-xs text-muted-foreground font-mono">
            <span className="text-primary">#</span> INNEI © {new Date().getFullYear()}
          </p>
          <a
            href="https://github.com/Innei/v0-personal-summary-site"
            target="_blank"
